...
then
	...
	cp -p backup.bash $tmpdir
	chmod u+x $tmpdir/backup.bash
	cd $tmpdir
	export testcaseprefix="Ex1"

echo '@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  backup.bash Tests  @@@@@@@@@@@@@@@@@@@@@@@@'
echo ''
echo '********************************************************************************'
...
printTestCaseNum
echo ./backup.bash $tmpdir/cb/bakdir 
./backup.bash $tmpdir/cb/bakdir 
prc=$?
echo "Return code from the program is $prc"
echo ''

printTestCaseNum
echo ./backup.bash $tmpdir/cb/bakdir nosuchdir
./backup.bash $tmpdir/cb/bakdir nosuchdir
prc=$?
echo "Return code from the program is $prc"
echo ''
...
printTestCaseNum
echo ./backup.bash $tmpdir/cb/bakdirnot $tmpdir/cb/srcdir
./backup.bash $tmpdir/cb/bakdirnot $tmpdir/cb/srcdir
prc=$?
echo "Return code from the program is $prc"
echo ''
...
echo ./backup.bash $tmpdir/cb/srcdir2 cb/srcdir2/
./backup.bash $tmpdir/cb/srcdir2 cb/srcdir2/
prc=$?
echo "Return code from the program is $prc"
echo ''

printTestCaseNum
echo ./backup.bash $tmpdir/cb/srcdir2/ $tmpdir/cb/srcdir2
./backup.bash $tmpdir/cb/srcdir2/ $tmpdir/cb/srcdir2
prc=$?
echo "Return code from the program is $prc"
echo ''
...
echo ./backup.bash $tmpdir/cb/bakdir $tmpdir/cb/srcdir
./backup.bash $tmpdir/cb/bakdir $tmpdir/cb/srcdir
prc=$?
echo "Return code from the program is $prc"
echo "Backup dir contents"
echo "ls -l $tmpdir/cb/bakdir/"
...
echo "ls -l $tmpdir/cb/bakdir/"
ls -l $tmpdir/cb/bakdir/
echo "echo n | ./backup.bash $tmpdir/cb/bakdir $tmpdir/cb/srcdir"
echo n | ./backup.bash $tmpdir/cb/bakdir $tmpdir/cb/srcdir
prc=$?
echo "Return code from the program is $prc"
...
echo "ls -l $tmpdir/cb/bakdir/"
ls -l $tmpdir/cb/bakdir/
echo "echo y | ./backup.bash $tmpdir/cb/bakdir $tmpdir/cb/srcdir"
echo y | ./backup.bash $tmpdir/cb/bakdir $tmpdir/cb/srcdir
prc=$?
echo "Return code from the program is $prc"
...
echo "ls -l $tmpdir/cb/bakdir/"
ls -l $tmpdir/cb/bakdir/
echo ./backup.bash $tmpdir/cb/bakdir cb/srcdir3/data
./backup.bash $tmpdir/cb/bakdir cb/srcdir3/data
echo "ls -l cb/bakdir/"
ls -l cb/bakdir/
...
fi #End of backup.bash test cases.
